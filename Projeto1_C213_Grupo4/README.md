...
Repositório criado para adicionar os códigos dos projetos da disciplina de Sitemas Embarcados
# C213_PID
...
- O sistema utiliza um setpoint normalizado (valor 100), representando a temperatura desejada do
forno.
